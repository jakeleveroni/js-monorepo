...
// /usr/include/curl/curl.h:1015:16: warning: struct demoted to opaque type - has bitfield
...
pub const CURLOPT_LASTENTRY: c_int = 327;
...
pub const CURLINFO_LASTONE: c_int = 66;
...
pub const struct_curl_version_info_data = extern struct {
    ...
    rtmp_version: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
...
pub const struct_CURLMsg = extern struct {
    ...
    data: union_unnamed_11 = @import("std").mem.zeroes(union_unnamed_11),
};
...
pub extern fn curl_multi_waitfds(multi: ?*CURLM, ufds: [*c]struct_curl_waitfd, size: c_uint, fd_count: [*c]c_uint) CURLMcode;
...
pub const CURLUE_LAST: c_int = 32;
...
pub const LIBCURL_VERSION = "8.9.1";
pub const LIBCURL_VERSION_MAJOR = @as(c_int, 8);
pub const LIBCURL_VERSION_MINOR = @as(c_int, 9);
pub const LIBCURL_VERSION_PATCH = @as(c_int, 1);
pub const LIBCURL_VERSION_NUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x080901, .hex);
pub const LIBCURL_TIMESTAMP = "2024-07-31";
...
// /usr/include/curl/system.h:487:13
...
pub const CURL_SSLVERSION_DEFAULT = @as(c_int, 0);
pub const CURL_SSLVERSION_TLSv1 = @as(c_int, 1);
pub const CURL_SSLVERSION_SSLv2 = @as(c_int, 2);
pub const CURL_SSLVERSION_SSLv3 = @as(c_int, 3);
pub const CURL_SSLVERSION_TLSv1_0 = @as(c_int, 4);
pub const CURL_SSLVERSION_TLSv1_1 = @as(c_int, 5);
pub const CURL_SSLVERSION_TLSv1_2 = @as(c_int, 6);
pub const CURL_SSLVERSION_TLSv1_3 = @as(c_int, 7);
pub const CURL_SSLVERSION_LAST = @as(c_int, 8);
pub const CURL_SSLVERSION_MAX_NONE = @as(c_int, 0);
...
// /usr/include/curl/mprintf.h:43:9
