...
// biome-ignore lint/suspicious/noExplicitAny: inherently polymorphic sorry
...
function parseArgs(): Partial<BuildConfig> {
  // biome-ignore lint/suspicious/noExplicitAny: could be anything man
...
if (existsSync(outdir)) {
  ...
  // @ts-expect-error -- its all good in bun baby
